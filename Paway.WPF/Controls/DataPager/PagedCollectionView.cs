...
namespace System.Windows.Data
{
    ...
    public sealed class PagedCollectionView : ICollectionView, IPagedCollectionView, IEditableCollectionView, INotifyPropertyChanged
    {
        ...
        private const string OperationNotAllowedForView = "'{0}' is not allowed for this view.";
        private const string OperationNotAllowedDuringTransaction = "'{0}' is not allowed during a transaction started by '{1}'.";
        private const string CancelEditNotSupported = "CancelEdit is not supported for the current edit item.";
        ...
        private const string RemoveNotSupported = "Remove/RemoveAt is not supported.";
        private const string NoCheckOrChangeWhenDeferred = "Cannot change or check the contents or current position of the PagedCollectionView while Refresh is being deferred.";
        ...
        public Predicate<object> Filter
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringAddOrEdit, "Filter"));
                }
        ...
        public object AddNew()
        {
            ...
            if (!CanAddNew)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedForView, "AddNew"));
            }
        ...
        public void CancelEdit()
        {
            if (IsAddingNew)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringTransaction, "CancelEdit", "AddNew"));
            }
        ...
        public void CancelNew()
        {
            if (IsEditingItem)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringTransaction, "CancelNew", "EditItem"));
            }
        ...
        public void CommitEdit()
        {
            if (IsAddingNew)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringTransaction, "CommitEdit", "AddNew"));
            }
        ...
        public void CommitNew()
        {
            if (IsEditingItem)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringTransaction, "CommitNew", "EditItem"));
            }
        ...
        public IDisposable DeferRefresh()
        {
            if (IsAddingNew || IsEditingItem)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringAddOrEdit, "DeferRefresh"));
            }
        ...
        public void RemoveAt(int index)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringAddOrEdit, "RemoveAt"));
            }
            else if (!CanRemove)
            {
...
#pragma warning restore IDE0018 // 内联变量声明
        ...
        private void OnGroupByChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsAddingNew || IsEditingItem)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringAddOrEdit, "Grouping"));
            }
        ...
        private void SortDescriptionsChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsAddingNew || IsEditingItem)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, OperationNotAllowedDuringAddOrEdit, "Sorting"));
            }
        ...
        private class CultureSensitiveComparer : IComparer<object>
        {
            ...
            public int Compare(object x, object y)
            {
                ...
                {
                    return (x as string).Compare(y as string);
                }
                else
                {
